subroutine enkf_driver_r4(ndim, nrens, nrobs, A, HA, obsdat, obserr) 
  ...
  real(kind=4), intent(inout) :: HA(nrobs,nrens)
  real(kind=4), intent(in) :: obsdat(nrobs)
  real(kind=4), intent(in) :: obserr(nrobs)
